...
```{r}
# temp <- read_tsv("ref_proj_pca.sscore")
# 
...
# )
# 
# write_tsv(proj_groups_file, "test_data/ref_proj_groups_file.tsv")
# gsutil_cp("test_data/ref_proj_groups_file.tsv", file.path(avbucket(), "test_data/"))
```
